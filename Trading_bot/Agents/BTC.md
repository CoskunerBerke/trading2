...
conviction: 12
price: 64334.0
updated: 2026-08-17T20:52:25+00:00
tags: [trading, agents]
---
# 🧠 BTC/USDT — Ajan Raporu (⚪ BEKLE, kanaat %12)
> ⚪ BEKLE · kanaat %12 · 2/3 yönlü ajan hemfikir · fiyat 64,334 · trend ayı  ·  2026-08-17 23:53

Şema: [[Agents/BTC.canvas]] · Backtest/karar: [[Coins/BTC]] · [[Agents/Baş Yönetici]]
...
- Saatlik: fiyat EMA200'ün üstünde, karışık dizilim, EMA50 eğimi %+0.43/10bar, ADX 40
...
Momentum nötr (RSI 1d/4h/1h: 42/70/70).
- Günlük: RSI14 42, MACD hist − (genişliyor), ROC10 %-2.2
- 4 saatlik: RSI14 70, MACD hist + (genişliyor), ROC10 %+1.9
- Saatlik: RSI14 70, MACD hist + (daralıyor), ROC10 %+1.6
- Metrikler: rsi_1d=42, macd_hist_1d=-163.5379, rsi_4h=70, macd_hist_4h=171.9057, rsi_1h=70, macd_hist_1h=79.7213
...
### 📡 Binance Canlı Piyasa Ajanı — AYI (bias -0.20, güven 50)
Canlı akış ayı: emir defteri alış payı %22, funding %0.0028, 24s %+2.05.
- 24s: %+2.05, aralık 62,716–64,610, fiyat aralığın %85'inde, hacim 915M USDT
- Emir defteri (ilk 20 kademe): alış 181K / satış 658K USDT → alış payı %22
- Funding %0.0028 / 8s (yıllık ≈ %3) → nötr
- Açık pozisyon (OI): 106,517 BTC
- Global long/short hesap oranı 1.56 (long %61)
- Metrikler: chg24_pct=2.05, high24=64610.01, low24=62716.0, pos24=0.85, vol24_usdt=915379706, ob_imbalance=0.22, spread_pct=0.0, funding_pct=0.0028, funding_annual_pct=3.1, open_interest=106517.454, long_short_ratio=1.56, long_pct=60.9
