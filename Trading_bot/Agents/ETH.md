...
conviction: 0
price: 1907.21
updated: 2026-08-17T21:18:24+00:00
tags: [trading, agents]
---
# 🧠 ETH/USDT — Ajan Raporu (⚪ BEKLE, kanaat %0)
> ⚪ BEKLE · kanaat %0 · 1/3 yönlü ajan hemfikir · fiyat 1,907 · trend boğa  ·  2026-08-18 00:19

Şema: [[Agents/ETH.canvas]] · Backtest/karar: [[Coins/ETH]] · [[Agents/Baş Yönetici]] · [[Paper Futures]]
...
- Kaldıraç kullanma. Yeniden değerlendirme: direnç 1,927 üstünde kapanış (long) / destek 1,897 altında kapanış (short)
...
## 🔀 EĞER … İSE
- EĞER 4h mum 1,927 üstünde hacimle kapanırsa → long senaryosu açılır (hedef 1,939)
- EĞER 4h mum 1,897 altında hacimle kapanırsa → short senaryosu açılır (hedef 1,886)

## 📍 Kilit seviyeler
| Seviye | Fiyat | Uzaklık |
|---|---|---|
| ema200_1d | 2,128 | +11.56% |
| r2 | 1,939 | +1.69% |
| r1 | 1,927 | +1.06% |
| ema_resistance | 1,919 | +0.62% |
| high_24h | 1,916 | +0.43% |
| s1 | 1,897 | -0.56% |
| s2 | 1,886 | -1.14% |
| ema20_1d | 1,883 | -1.26% |
| ema_support | 1,883 | -1.26% |
| low_24h | 1,869 | -1.99% |
| ema50_1d | 1,867 | -2.13% |
...
- Saatlik: fiyat EMA200'ün üstünde, boğa dizilimi (20>50>200), EMA50 eğimi %+0.34/10bar, ADX 29
...
Yakın direnç 1,927 (+1.1%); yakın destek 1,897 (−0.6%). Fiyat son aralığın %44'inde.
- 1,927 üstünde 4h kapanış → hedef 1,939
...
- Metrikler: resistances=[1927.3475, 1939.386, 1949.76, 1956.45, 1967.0, 1981.24], supports=[1896.538, 1885.5325, 1875.514, 1866.27, 1854.50166667, 1847.512], range_position=0.44, range_high=2423.75, range_low=1505.68

### 🚀 Momentum Ajanı — AYI (bias -0.27, güven 53)
Momentum ayı (RSI 1d/4h/1h: 50/61/57).
- Günlük: RSI14 50, MACD hist − (genişliyor), ROC10 %-1.5
- 4 saatlik: RSI14 61, MACD hist + (daralıyor), ROC10 %+1.3
- Saatlik: RSI14 57, MACD hist − (daralıyor), ROC10 %-0.0
- Metrikler: rsi_1d=50, macd_hist_1d=-5.8214, rsi_4h=61, macd_hist_4h=3.5731, rsi_1h=57, macd_hist_1h=-0.0994
...
Canlı akış nötr: emir defteri alış payı %30, funding %0.0039, 24s %+1.34.
- 24s: %+1.34, aralık 1,869–1,916, fiyat aralığın %82'inde, hacim 347M USDT
- Emir defteri (ilk 20 kademe): alış 121K / satış 286K USDT → alış payı %30
- Funding %0.0039 / 8s (yıllık ≈ %4) → nötr
- Açık pozisyon (OI): 2,379,634 ETH
- Global long/short hesap oranı 2.34 (long %70)
- Metrikler: chg24_pct=1.34, high24=1915.5, low24=1869.17, pos24=0.82, vol24_usdt=347213181, ob_imbalance=0.3, spread_pct=0.0005, funding_pct=0.0039, funding_annual_pct=4.2, open_interest=2379634.46, long_short_ratio=2.34, long_pct=70.0
