...
conviction: 0
price: 1906.69
updated: 2026-08-17T21:38:45+00:00
tags: [trading, agents]
---
# 🧠 ETH/USDT — Ajan Raporu (⚪ BEKLE, kanaat %0)
> ⚪ BEKLE · kanaat %0 · 1/3 yönlü ajan hemfikir · fiyat 1,907 · trend boğa  ·  2026-08-18 00:39
...
|---|---|---|
| ema200_1d | 2,128 | +11.59% |
| r2 | 1,927 | +1.08% |
| ema_resistance | 1,919 | +0.65% |
| high_24h | 1,916 | +0.46% |
| r1 | 1,911 | +0.22% |
| s1 | 1,897 | -0.53% |
| s2 | 1,886 | -1.11% |
| ema20_1d | 1,883 | -1.23% |
| ema_support | 1,883 | -1.23% |
| low_24h | 1,869 | -1.97% |
| ema50_1d | 1,867 | -2.10% |
...
Yakın direnç 1,911 (+0.2%); yakın destek 1,897 (−0.5%). Fiyat son aralığın %44'inde.
...
Canlı akış nötr: emir defteri alış payı %30, funding %0.0043, 24s %+1.42.
- 24s: %+1.42, aralık 1,869–1,916, fiyat aralığın %81'inde, hacim 345M USDT
- Emir defteri (ilk 20 kademe): alış 113K / satış 265K USDT → alış payı %30
- Funding %0.0043 / 8s (yıllık ≈ %5) → nötr
- Açık pozisyon (OI): 2,378,910 ETH
- Global long/short hesap oranı 2.34 (long %70)
- Metrikler: chg24_pct=1.42, high24=1915.5, low24=1869.17, pos24=0.81, vol24_usdt=344902784, ob_imbalance=0.3, spread_pct=0.0005, funding_pct=0.0043, funding_annual_pct=4.7, open_interest=2378910.235, long_short_ratio=2.34, long_pct=70.0
