...
conviction: 9
price: 75.95
updated: 2026-08-17T20:52:43+00:00
tags: [trading, agents]
---
# 🧠 SOL/USDT — Ajan Raporu (⚪ BEKLE, kanaat %9)
> ⚪ BEKLE · kanaat %9 · 2/3 yönlü ajan hemfikir · fiyat 75.95 · trend boğa  ·  2026-08-17 23:53

Şema: [[Agents/SOL.canvas]] · Backtest/karar: [[Coins/SOL]] · [[Agents/Baş Yönetici]]
...
|---|---|---|
| ema200_1d | 89.18 | +17.41% |
| ema_resistance | 78.15 | +2.90% |
| r2 | 76.81 | +1.13% |
| r1 | 76.28 | +0.43% |
| high_24h | 76.22 | +0.36% |
| s1 | 75.67 | -0.37% |
| ema50_1d | 75.49 | -0.61% |
| ema_support | 75.49 | -0.61% |
| s2 | 75.23 | -0.94% |
| ema20_1d | 75.12 | -1.10% |
| strategy_stop | 74.40 | -2.04% |
| low_24h | 74.10 | -2.44% |
...
- Saatlik: fiyat EMA200'ün üstünde, boğa dizilimi (20>50>200), EMA50 eğimi %+0.21/10bar, ADX 13
...
Yakın direnç 76.28 (+0.4%); yakın destek 75.67 (−0.4%). Fiyat son aralığın %41'inde.
...
### 🚀 Momentum Ajanı — GÜÇLÜ BOĞA (bias +0.54, güven 67)
Momentum güçlü boğa (RSI 1d/4h/1h: 48/53/55).
- Günlük: RSI14 48, MACD hist + (daralıyor), ROC10 %+2.6
- 4 saatlik: RSI14 53, MACD hist + (genişliyor), ROC10 %+0.3
- Saatlik: RSI14 55, MACD hist + (daralıyor), ROC10 %+0.6
- Metrikler: rsi_1d=48, macd_hist_1d=0.1258, rsi_4h=53, macd_hist_4h=0.0776, rsi_1h=55, macd_hist_1h=0.0326
...
Canlı akış nötr: emir defteri alış payı %47, funding %-0.0041, 24s %+1.25.
- 24s: %+1.25, aralık 74.10–76.22, fiyat aralığın %87'inde, hacim 101M USDT
- Emir defteri (ilk 20 kademe): alış 838K / satış 956K USDT → alış payı %47
- Funding %-0.0041 / 8s (yıllık ≈ %-5) → nötr
- Açık pozisyon (OI): 8,670,345 SOL
- Global long/short hesap oranı 2.37 (long %70)
- Metrikler: chg24_pct=1.25, high24=76.22, low24=74.1, pos24=0.87, vol24_usdt=100893942, ob_imbalance=0.47, spread_pct=0.0132, funding_pct=-0.0041, funding_annual_pct=-4.5, open_interest=8670345.14, long_short_ratio=2.37, long_pct=70.3
