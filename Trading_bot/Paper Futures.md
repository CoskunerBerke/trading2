...
## Kapanan işlemler (son 30)
| ID | Sembol | Yön | Giriş | Çıkış nedeni | P&L | R | Bar | Kaldıraç | Setup | Kapanış |
|---|---|---|---|---|---|---|---|---|---|---|

Kurallar: TP1'de yarı kapat + stop başa-baş · likidasyon izole marj yaklaşık · funding 8s'te bir · taker %0.05 + kayma %0.03
