# -*- coding: utf-8 -*-
"""Rejim kapisi (ENFORCE r1) dagitim paketi: bundle + betik. ROOT ile calisir, depo islemleri
`tradingbot` adina. Taban: VPS'te dogrulanan 5fc4507."""
import hashlib
import io
import subprocess
...
BASE = "5fc4507cd4dee8e7c88ef8e686f419b787985dff"
...
#  Taban : @BASE@ (VPS'te 2026-09-12 20:17Z dogrulandi); baskasinda betik DURUR
#  Hedef : @TARGET@
