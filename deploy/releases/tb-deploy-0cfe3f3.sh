...
#  Taban : 1c4cba1b49307c10a53f0c25a62eccb229b3da1f (1c4cba1) YA DA e1af16624a94d441247429fe800779798f5ba2aa (e1af166); baskasinda betik DURUR
#  Hedef : 0cfe3f3de51d3e37681f87972d672f9fcfdfe91a
#  Bundle: tb-0cfe3f3.bundle   sha256 7c964b8fbf8fba51e1e7e1472bf98bd37e020a8591588d1eb89a3a11d8fe361e
#
#  Ne degisiyor:
...
#  KULLANIM (VPS'te):  sudo bash ~/tb-deploy-0cfe3f3.sh
#  Cikis kodu 0 ve son satirda DEPLOY_OK gorunmelidir.
# =============================================================================
set -uo pipefail

BASE_SHA="1c4cba1b49307c10a53f0c25a62eccb229b3da1f"
BASE_ALT_SHA="e1af16624a94d441247429fe800779798f5ba2aa"
TARGET_SHA="0cfe3f3de51d3e37681f87972d672f9fcfdfe91a"
BUNDLE_SHA="7c964b8fbf8fba51e1e7e1472bf98bd37e020a8591588d1eb89a3a11d8fe361e"
BUNDLE_NAME="tb-0cfe3f3.bundle"
...
[[ $EUID -eq 0 ]] || fail "root gerekli: sudo bash ~/tb-deploy-0cfe3f3.sh"
