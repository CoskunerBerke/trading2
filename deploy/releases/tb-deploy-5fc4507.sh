...
#  Taban : 0cfe3f3de51d3e37681f87972d672f9fcfdfe91a (VPS'te 2026-09-12 15:23Z dogrulandi); baskasinda betik DURUR
#  Hedef : 5fc4507cd4dee8e7c88ef8e686f419b787985dff
#  Bundle: tb-5fc4507.bundle   sha256 17601774f44c99e102b9edecf8f4f04bb2fc5ba54fca35da0c4ff0878a757343
#
#  Ne degisiyor:
...
#  KULLANIM (VPS'te):  sudo bash ~/tb-deploy-5fc4507.sh
# =============================================================================
set -uo pipefail

BASE_SHA="0cfe3f3de51d3e37681f87972d672f9fcfdfe91a"
TARGET_SHA="5fc4507cd4dee8e7c88ef8e686f419b787985dff"
BUNDLE_SHA="17601774f44c99e102b9edecf8f4f04bb2fc5ba54fca35da0c4ff0878a757343"
BUNDLE_NAME="tb-5fc4507.bundle"
...
[[ $EUID -eq 0 ]] || fail "root gerekli: sudo bash ~/tb-deploy-5fc4507.sh"
