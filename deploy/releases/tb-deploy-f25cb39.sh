...
#  Taban : a619fb07e62b500101f9c9a16d8bde40aa7843a9 (VPS'te 2026-09-13 18:33Z dogrulandi); baskasinda betik DURUR
#  Hedef : f25cb39ebe8b91932e3e80cef058def5f4040966
#  Bundle: tb-f25cb39.bundle   sha256 dcdedd330ff5000b4e93d4407d2d81ca805ec9462f043671ac09c704af81e23c
#
#  Ne degisiyor:
...
#  KULLANIM (VPS'te):  sudo bash ~/tb-deploy-f25cb39.sh
# =============================================================================
set -uo pipefail

BASE_SHA="a619fb07e62b500101f9c9a16d8bde40aa7843a9"
TARGET_SHA="f25cb39ebe8b91932e3e80cef058def5f4040966"
BUNDLE_SHA="dcdedd330ff5000b4e93d4407d2d81ca805ec9462f043671ac09c704af81e23c"
BUNDLE_NAME="tb-f25cb39.bundle"
...
[[ $EUID -eq 0 ]] || fail "root gerekli: sudo bash ~/tb-deploy-f25cb39.sh"
...
echo "   Ilk tur ~10-15 dk sonra: journal'da 'STRATEJI KAGIT DEFTERI: name=m2_tsmom28' ve $STATE/strategy_paper_m2.json + strategy_paper_index.json"
